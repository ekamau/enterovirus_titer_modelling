...
# titration data
df <- read.csv('data/raw/CA6_raw_well_observations.csv', header = TRUE, sep = ',')
...
fit <- rstan::sampling(model, data = stan_data, chains = 4, iter = 2000, init = initf)
fit
launch_shinystan(fit)

saveRDS(fit, "~/titer_work_files/analyses_25Mar23/processed/modelFit_E71.rds")
#--------------------------------------------------------------------------------------------
...
g <- ggplot(data = df2, aes(x = dilutions, y = prob)) +
...
ggsave("figures/enterovirus_data/E71_ppc_25Mar23.pdf", g, width = 6, height = 6, dpi = 300)
...
h
ggsave("figures/enterovirus_data/E71_logphi_titers.pdf", h, width = 6, height = 6, dpi = 300)
...
j
ggsave("figures/enterovirus_data/E71_logphi_byAge.pdf", j, width = 8, height = 6, dpi = 300)
...
l
ggsave("figures/enterovirus_data/E71_logphi_byYear.pdf", l, width = 8, height = 6, dpi = 300)
